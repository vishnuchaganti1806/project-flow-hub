...
const mockReviews: Review[] = [
  { id: "r1", studentId: "s1", studentName: "Aarav Patel", rating: 4, comment: "Good progress on AI navigation module. Keep up the work.", createdAt: "2026-02-08" },
  ...
  { id: "r4", studentId: "s5", studentName: "Vikram Joshi", rating: 3, comment: "Needs to narrow project scope. Resubmit required.", createdAt: "2026-01-28" },
  { id: "r5", studentId: "s2", studentName: "Priya Singh", rating: 4, comment: "Solid technical foundation. Improve documentation.", createdAt: "2026-01-25" },
];
  ...
  return useQuery<Review[]>({
    ...
    queryFn: async () => {
      try {
        ...
        // No getAll endpoint, return mock
        return mockReviews;
      } catch {
